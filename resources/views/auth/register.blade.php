        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="password_confirmation" class="col-md-4 col-form-label text-md-end text-start">Wachtwoord Bevestigen</label>
                        <div class="col-md-6">
                          <input type="password" class="form-control" id="password_confirmation" name="password_confirmation">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-primary" value="Registreer">
                    </div>
                </form>
            </div>
        </div>
