  ...
  <div class="sticky-top">
    <div class="mt-4">
      ...
      <ul class="nav nav-pills flex-column  mt-2 mt-sm-0" id="menu">
        ...
        <hr class="text-white" />
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start ">
          <a class="nav-link text-white" href="{{route('admin.home.index')}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin.history.index')}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin.actueel.index')}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin.projecten.index')}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin.meyd.index')}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin.agenda.index')}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin.plaatselijkbelang.index')}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin.brinkpraat.index')}}" aria-current="page">
