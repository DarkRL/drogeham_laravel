  ...
  <div class="sticky-top">
    <div class="mt-4">
      ...
      <ul class="nav nav-pills flex-column  mt-2 mt-sm-0" id="menu">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin', ['admin' => 'history/index'])}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin', ['admin' => 'actueel/index'])}}" aria-current="page">
        ...
        <li class="nav-item my-1 hoverOnLink text-center text-sm-start">
          <a class="nav-link text-white" href="{{route('admin', ['admin' => 'agenda/index'])}}" aria-current="page">
